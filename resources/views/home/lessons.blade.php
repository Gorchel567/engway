<article id="lessons">
    <div class="container">
            ...
            <div class="col" id="lessons-header">
                ...
                <div class="row">
                    <div class="col-lg-6 col-12">
                        <ul>
                            <li>Занимаюсь с детьми (начиная с 10-11 лет), с подростками и взрослыми.</li>
                            <li>Перед началом обучения провожу тестирование, на нем узнаю уровень языка, интересы, цели и задачи ученика для дальнейшего эффективного планирования обучения.</li>
                            <li>Групповые занятия проходят только у школьников, в группах не более 4 человек - 2 раза в неделю по 60-75 минут, в зависимости от уровня и возраста..</li>
                        </ul>
                    </div>
                    <div class="col-lg-6 col-12">
                        <ul>
                            <li>Индивидуально занимаюсь со школьниками и взрослыми. Занятия длятся от 60 до 90 минут.</li>
                            <li>Максимум языковой практики.</li>
                            <li>Онлайн занятия проходят в Zoom + онлайн доска Miro и google docs.</li>
                            <li>Оплата занятий происходит в начале каждого месяца</li>
                        </ul>
                    </div>
                </div>
            </div>
        ...
        <div class="row lessons-container">
            ...
            <!--</div>-->
            <div class="col-lg-6 col-6 text-center lessons-block" data-id="two" data-title="Групповые занятия (5-6 класс)">
                <img class="block" src="/images/lesson_two.png" alt="Lesson Two">
                <p class="price block">4 200 – 5 600 ₽ / мес.</p>
            </div>
            <div class="col-lg-6 col-6 text-center lessons-block" data-id="three" data-title="Групповые занятия (7-11 класс)">
                <img class="block" src="/images/lesson_three.png" alt="Lesson Three">
                <p class="price block">4 500 – 6 000 ₽ / мес.</p>
            </div>
            <div class="col-lg-6 col-6 text-center lessons-block" data-id="four" data-title="Подготовка к ОГЭ\ЕГЭ">
