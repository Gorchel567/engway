...
@section("content")
    <div class="container" id="private-page">
        <div class="row">
            ...
            <div class="col-12">
                ...
                <p>
                    Все лица, заполнившие сведения, составляющие персональные данные на сайте <a href="{{env('APP_URL')}}">{{env('APP_URL')}}</a>, а также разместившие иную информацию обозначенными действиями, подтверждают свое согласие на обработку персональных данных и их передачу оператору обработки персональных данных – СЗ Рогозина Елизавета Владимировна (ИНН 782002419721 далее именуемое как – «Оператор»).
                </p>
                ...
                <p>
                    Персональные данные, указанные Пользователем Сайта, хранятся в информационной системе персональных данных сайта <a href="{{env('APP_URL')}}">{{env('APP_URL')}}</a>.
                </p>
